...
#in production it's infrastructure.2u.com
...
#in this case it creates NS recoreds for demo.infrastructure.2u.com pointing to the NS records our delegated domain(infrastructure.2u.com in sub account) zone
